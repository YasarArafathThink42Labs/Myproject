...
Select Case strAction
    Case "start"
         iRet = DoCmd("net start PostgreSQL_For_Odoo")
    Case "stop"
         iRet = DoCmd("net stop PostgreSQL_For_Odoo")
    Case "reload"
         iRet = DoCmd("""C:\Program Files (x86)\Odoo 9.0-20160623\PostgreSQL\bin\pg_ctl.exe"" -D ""C:\Program Files (x86)\Odoo 9.0-20160623\PostgreSQL\data"" reload")
    Case "restart"
	     iRet = DoCmd("net stop PostgreSQL_For_Odoo")
		 If iRet = 0 Then
		     iRet = DoCmd("net start PostgreSQL_For_Odoo")
